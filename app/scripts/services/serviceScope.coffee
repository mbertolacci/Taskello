...
angular.module('serviceScope').factory '$serviceScope', ['$rootScope', '$cleanQ', '$compose', ($rootScope, $cleanQ, $compose) ->
	() ->
...
angular.module('serviceScope').factory '$cleanQ', ['$exceptionHandler', ($exceptionHandler) ->
